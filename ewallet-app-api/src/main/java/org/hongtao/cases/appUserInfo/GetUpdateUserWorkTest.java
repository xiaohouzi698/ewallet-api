...
import static org.hongtao.config.TestConfig.getUpdateUserWorkUrl;
import static org.hongtao.config.TestConfig.appUserLoginUrl;

public class GetUpdateUserWorkTest {
    ...
    public void beforeTest() {
        getUpdateUserWorkUrl = ConfigFile.getUrl(InterfaceName.GETUPDATEUSERWORK);
        appUserLoginUrl = ConfigFile.getUrl(InterfaceName.APPUSERLOGIN);
    }


    @Test(description = "getUpdateUserWork")
    public void getUpdateUserWork() throws IOException, URISyntaxException, BadPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, NoSuchPaddingException, InvalidKeyException, InvalidKeySpecException {
    ...
    private JSONObject getJsonResult(String token ) throws IOException, URISyntaxException {
        ...
        URIBuilder uriBuilder = new URIBuilder(getUpdateUserWorkUrl);
