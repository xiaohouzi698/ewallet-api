...
import static org.hongtao.config.TestConfig.getUpdateUserInfoUrl;
import static org.hongtao.config.TestConfig.appUserLoginUrl;

public class GetUpdateUserInfoTest {
    ...
    public void beforeTest() {
        getUpdateUserInfoUrl = ConfigFile.getUrl(InterfaceName.GETUPDATEUSERINFO);
        appUserLoginUrl = ConfigFile.getUrl(InterfaceName.APPUSERLOGIN);
    }

    @Test(description = "getUpdateUserInfo")
    public void getUpdateUserInfo() throws IOException, URISyntaxException, BadPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, NoSuchPaddingException, InvalidKeyException, InvalidKeySpecException {
    ...
    private JSONObject getJsonResult(String token ) throws IOException, URISyntaxException {
        ...
        URIBuilder uriBuilder = new URIBuilder(getUpdateUserInfoUrl);
