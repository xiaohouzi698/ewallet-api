...
public class QueryCertificationStatusTest {
    private static Logger logger = Logger.getLogger(String.valueOf(QueryCertificationStatusTest.class));
    ...
    @Test(description = "queryCertificationStatus")
    public void queryCertificationStatus() throws IOException, URISyntaxException, BadPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, NoSuchPaddingException, InvalidKeyException, InvalidKeySpecException {
    ...
    private JSONObject getJsonResult(String token ) throws IOException, URISyntaxException {
        ...
        URIBuilder uriBuilder = new URIBuilder(queryCertificationStatusUrl);
