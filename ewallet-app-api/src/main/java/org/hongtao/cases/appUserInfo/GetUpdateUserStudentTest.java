...
import static org.hongtao.config.TestConfig.getUpdateUserStudentUrl;
import static org.hongtao.config.TestConfig.appUserLoginUrl;

public class GetUpdateUserStudentTest {
    ...
    public void beforeTest() {
        getUpdateUserStudentUrl = ConfigFile.getUrl(InterfaceName.GETUPDATEUSERSTUDENT);
        appUserLoginUrl = ConfigFile.getUrl(InterfaceName.APPUSERLOGIN);
    }

    @Test(description = "getUpdateUserStudent")
    public void getUpdateUserStudent() throws IOException, URISyntaxException, BadPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, NoSuchPaddingException, InvalidKeyException, InvalidKeySpecException {
    ...
    private JSONObject getJsonResult(String token ) throws IOException, URISyntaxException {
        ...
        URIBuilder uriBuilder = new URIBuilder(getUpdateUserStudentUrl);
