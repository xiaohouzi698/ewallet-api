...
import static org.hongtao.config.TestConfig.getUserBankCardUrl;
import static org.hongtao.config.TestConfig.appUserLoginUrl;

public class GetUserBankCardTest {
    ...
    public void beforeTest() {
        getUserBankCardUrl = ConfigFile.getUrl(InterfaceName.GETUSERBANKCARD);
        appUserLoginUrl = ConfigFile.getUrl(InterfaceName.APPUSERLOGIN);
    }


    @Test(description = "getUserBankCard")
    public void getUserBankCard() throws IOException, URISyntaxException, BadPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, NoSuchPaddingException, InvalidKeyException, InvalidKeySpecException {
    ...
    private JSONObject getJsonResult(String token ) throws IOException, URISyntaxException {
        ...
        URIBuilder uriBuilder = new URIBuilder(getUserBankCardUrl);
